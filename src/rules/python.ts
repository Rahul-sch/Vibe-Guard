...
export const pythonRules: DetectionRule[] = [
  ...
  },
  {
    ...
    languages: ['python'],
    filePatterns: ['*.py'],
    pattern: /(?:open|send_file)\s*\(\s*request\.(?:args|form|values)(?:\.get\s*\([^)]*\)|\s*\[[^\]]+\])/g,
  ...
  },
  {
    ...
    languages: ['python'],
    filePatterns: ['*.py'],
    pattern: /requests\.(?:get|post|put|patch|delete|head|request)\s*\(\s*request\.(?:args|form|values)(?:\.get\s*\([^)]*\)|\s*\[[^\]]+\])/g,
